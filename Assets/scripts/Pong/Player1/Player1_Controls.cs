// GENERATED AUTOMATICALLY FROM 'Assets/scripts/Pong/Player1/Player1_Controls.inputactions'
...
public class @Player1_Controls : IInputActionCollection, IDisposable
{
    ...
    public struct MovementMapActions
    {
        ...
        public MovementMapActions(@Player1_Controls wrapper) { m_Wrapper = wrapper; }
